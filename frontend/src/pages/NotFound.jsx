...
export default function NotFound({ goTo }) {
  return (
    <section className="relative -mt-[52px] -mb-[52px] grid min-h-svh place-items-center overflow-hidden bg-paper text-center max-[820px]:-mt-8 max-[820px]:-mb-8 max-[560px]:-mt-7 max-[560px]:-mb-7">
      ...
      <div className="relative z-[1] px-6">
        <p className="text-[11px] font-bold tracking-[0.1em] text-muted uppercase">Error 404</p>
        ...
        <p className="mx-auto mt-6 max-w-[360px] text-[13px] leading-6 text-muted">
